...
This co-op mini-adventure takes place in the realm Verdant Grove. The objective of this mini-adventure is to escort the NPA,Elara, safely to the target, all while avoiding hazards and using items to protect Elara. Each player takes turns moving on a grid. Each turn, the player can move in a cardinal direction by entering either north, east, south, or west, or they can guard the NPC, or wait. If Elara reaches the target, the players win. Otherwise, if 30 turns are completed without winning, or the players or Elara goes to 0 hp, the players lose.
### Hazards
